...
internal static class TabsUtil
{
    ...
    internal static Tab VanillaGeneral => new()
    {
        ...
        ChatCodes = new Dictionary<ChatType, ChatSource>
        {
            ...
            [ChatType.MareLinkshell1] = ChatSourceExt.All,
            [ChatType.MareLinkshell2] = ChatSourceExt.All,
            [ChatType.MareLinkshell3] = ChatSourceExt.All,
            [ChatType.MareLinkshell4] = ChatSourceExt.All,
            [ChatType.MareLinkshell5] = ChatSourceExt.All,
            [ChatType.MareLinkshell6] = ChatSourceExt.All,
            [ChatType.MareLinkshell7] = ChatSourceExt.All,
            [ChatType.MareLinkshell8] = ChatSourceExt.All,
